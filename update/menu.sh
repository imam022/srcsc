...
Exp=$(curl -sS https://raw.githubusercontent.com/imam022/titid/main/ip | grep $MYIP | awk '{print $3}')
fi
...
06 | 6) clear ; menu-dns ;;
07 | 7) clear ; gotop ;;
08 | 8) clear ; wget https://raw.githubusercontent.com/imam022/srcsc/main/update/update.sh && chmod +x update.sh && ./update.sh ;;
